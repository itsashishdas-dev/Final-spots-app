...
import { MapPin, Navigation, Clock, Zap, X, Users, Droplets, Wind, Activity, Crosshair, ChevronRight, AlertTriangle, Plus, Swords, Calendar, Share2, Lock, EyeOff, Play, Video, Image as ImageIcon, MessageSquare, UserPlus } from 'lucide-react';
...
const SpotPreviewCard: React.FC<SpotPreviewCardProps> = ({ spot, sessions, challenges, crew, onClose, onCheckIn }) => {
  const { location, openModal, user, openChat, joinSession } = useAppStore();
  ...
  return (
    <div className={containerClasses}>
        <div className={cardClasses}>
            ...
            {/* Screws (Visible in expanded view) */}
